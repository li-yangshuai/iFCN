...
public:
    GeneticAlgorithm(Parse &_parse, GridChessboard &_chessboard, Astar &_astar,
    ...
    auto getNodePos() const {
        return  best_individuals.back().nodeindex_pos;
    }
    ...
    auto getCrossPos() {
        ...
        return best_individuals.back().cross_nodes_pos;
    }
