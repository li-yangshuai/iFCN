...
Shared utilities describe, sample, install, and validate immutable clock fields
for grid routers. This module does not expose a placement or routing entry point.
...
def sample_clock_field(bounds: Bounds, spec: ClockFieldSpec) -> ClockField:
    ...
    if spec.mode == "raw":
        ...
        return ClockField(
            ...
            phases=phases,
            causal=False,
            # No causal secondary-axis advance is defined for a raw field.
