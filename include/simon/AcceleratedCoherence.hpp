...
struct AcceleratedCoherenceEngine : public CoherenceEngine<Host> {
    ...
    void before_iterations(QCADesign &design, const Result &result) {
        // Design initialization precedes I/O discovery because it may remove
        // duplicate cells. Generator-backed caches require the final ordered
        // I/O pointers and initialized input/clock callables.
