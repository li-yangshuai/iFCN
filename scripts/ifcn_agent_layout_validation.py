"""Independent artifact validation shared by the Pi layout adapters.

These checks establish routed geometry and clock-step legality. They deliberately
make no RTL equivalence, latency alignment, or physical-functional signoff claim.
"""
...
def validate_candidate(candidate, *, source_crossings=False):
    ...
    return {'passed': not errors, 'checks': check_names, 'errors': errors,
            ...
            'scope': 'Geometric routes, physical gate ports, and forward clock steps; not RTL equivalence, latency alignment, or device-level functional signoff.'}
